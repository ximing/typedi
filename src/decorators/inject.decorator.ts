...
export function Inject(typeFn: (type?: never) => Constructable<unknown>): PropertyDecorator & ParameterDecorator;
export function Inject(serviceName?: string): PropertyDecorator & ParameterDecorator;
export function Inject(token: Token<unknown>): PropertyDecorator & ParameterDecorator;
